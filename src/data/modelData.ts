...
export const orgLogoMap: { [key: string]: string } = {
  'Microsoft': '/openrca_leadboard/ms_logo.svg',
  'Google': '/openrca_leadboard/google_logo.svg',
  'OpenAI': '/openrca_leadboard/openai_logo.svg',
  'Anthropic': '/openrca_leadboard/anthropic_logo.svg',
  'Meta': '/openrca_leadboard/meta_logo.svg'
};
