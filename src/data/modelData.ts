...
export const modelDataOpenRCA: Data[] = [
  ...
  { name: 'RCA-Agent', model: 'Claude 3.5 Sonnet', org: 'OpenRCA', correct: '11.34%', date: '2025/1/23', frameworkOpen: true, modelOpen: false, reproduced: true, trajUrl: 'https://example.com/traj/rca-agent-claude' },
